...
export class UserFormComponent implements OnInit {
  ...
  public saveData(): void {
    if (
      isNil(this.user.name) ||
      this.user.name === '' ||
      isNil(this.user.surname) ||
      this.user.surname === '' ||
      isNil(this.user.email) ||
      this.user.email === '' ||
      isNil(this.user.password) ||
      this.user.password === '' ||
      isNil(this.user.userName) ||
      this.user.userName === '' ||
      isNil(this.user.location) ||
      this.user.location === '' ||
      isNil(this.user.typeMedia) ||
      this.user.typeMedia === '' ||
      isNil(this.user.genre) ||
      this.user.genre === ''
    ) {
